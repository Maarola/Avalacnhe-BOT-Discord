    ...
    if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.ManageGuild)) {
      ...
      let button = new Discord.ActionRowBuilder().addComponents(
        new Discord.ButtonBuilder()
          .setCustomId("botao")
          .setEmoji("<a:sorteio:1111817300996280320>")
...
Clique no botão para parcipar.\n**Boa sorte!!!**`)
      ...
      coletor.on("collect", (i) => {
        ...
        if (i.customId === "botao") {
          ...
          let embed_y = new Discord.EmbedBuilder()
          .setColor("#752a41")
          .setTitle(`<a:sorteio:1111817300996280320> | Avalanche System`)
          .setDescription(`**${interaction.user}, você entrou no sorteio.**`)
          ...
          i.reply({ embeds: [embed_y], ephemeral: true });
        }
      ...
      setTimeout(() => {
        ...
        let embed_g = new Discord.EmbedBuilder()
          .setColor("#752a41")
          .setTitle(`<a:sorteio:1111817300996280320> | Avalanche System`)
          .setDescription(`**Parabéns <@${ganhador}> você ganhou o sorteio: \`${premio}\`.**`)

        interaction.followUp({ embeds: [embed_g]});
